...
import { validateRegistration, validateLogin, validateRefreshToken, validateForgotPassword, validateResetPassword, validateVerifyEmail, sanitizeBody, } from "../middleware/validation.js";
const router = express.Router();
// Apply sanitization to all routes
router.use(sanitizeBody);
// POST /api/auth/contractor/register - Contractor registration
router.post("/contractor/register", validateRegistration, authController.register);
...
router.post("/contractor/refresh", validateRefreshToken, authController.refresh);
...
router.post("/contractor/forgot-password", validateForgotPassword, authController.forgotPassword);
// POST /api/auth/contractor/reset-password - Reset password
router.post("/contractor/reset-password", validateResetPassword, authController.resetPassword);
...
router.post("/contractor/verify-email", validateVerifyEmail, authController.verifyEmail);
