 ...
 */
export declare function sendVerificationEmail(email: string, name: string, verificationToken: string): Promise<void>;
/**
 ...
 */
export declare function sendPasswordResetEmail(email: string, name: string, resetToken: string): Promise<void>;
/**
 ...
 * @param name Contractor's name
 */
export declare function sendPasswordChangeAlert(email: string, name: string): Promise<void>;
