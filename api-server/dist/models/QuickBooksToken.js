...
QuickBooksTokenSchema.methods.isExpiringSoon = function (minutesThreshold = 30) {
...
QuickBooksTokenSchema.statics.findExpiringSoon = function (minutesThreshold = 30) {
    const thresholdTime = new Date();
    thresholdTime.setMinutes(thresholdTime.getMinutes() + minutesThreshold);
    return this.find({
        isActive: true,
...
QuickBooksTokenSchema.statics.findByRealmId = function (realmId) {
    return this.findOne({ realmId, isActive: true }).populate("contractorId", "name email");
};
