...
export declare class PhotoUploadService {
     ...
     */
    static uploadPhoto(photoData: string, options?: PhotoUploadOptions): Promise<PhotoUploadResult>;
    /**
     * Upload multiple photos
     * @param photosData Array of photo data
     * @param options Upload options
     */
    static uploadMultiplePhotos(photosData: string[], options?: PhotoUploadOptions): Promise<PhotoUploadResult[]>;
    /**
     ...
     */
    static getOptimizedUrl(publicId: string, transformations?: any): string | null;
    /**
