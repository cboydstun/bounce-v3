...
export declare const validateRegistration: (
  req: Request,
  res: Response,
  next: NextFunction,
) => void;
export declare const validateLogin: (
  req: Request,
  res: Response,
  next: NextFunction,
) => void;
export declare const validateRefreshToken: (
  req: Request,
  res: Response,
  next: NextFunction,
) => void;
export declare const validateForgotPassword: (
  req: Request,
  res: Response,
  next: NextFunction,
) => void;
export declare const validateResetPassword: (
  req: Request,
  res: Response,
  next: NextFunction,
) => void;
export declare const validateVerifyEmail: (
  req: Request,
  res: Response,
  next: NextFunction,
) => void;
export declare const validateUpdateProfile: (
  req: Request,
  res: Response,
  next: NextFunction,
) => void;
export declare const validateChangePassword: (
  req: Request,
  res: Response,
  next: NextFunction,
) => void;
export declare const validatePagination: (
  req: Request,
  res: Response,
  next: NextFunction,
) => void;
...
export declare const validateW9Form: (
  req: Request,
  res: Response,
  next: NextFunction,
) => void;
export declare const validateW9Update: (
  req: Request,
  res: Response,
  next: NextFunction,
) => void;
 ...
 */
export declare const sanitizeBody: (
  req: Request,
  res: Response,
  next: NextFunction,
) => void;
