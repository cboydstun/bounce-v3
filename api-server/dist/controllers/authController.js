...
import { sendVerificationEmail, sendPasswordResetEmail, sendWelcomeEmail, sendPasswordChangeAlert, } from "../utils/emailService.js";
import { generateEmailVerificationToken, generatePasswordResetToken, generateExpirationDate, } from "../utils/tokens.js";
    ...
    async refresh(req, res) {
        try {
            ...
            if (shouldRotateRefreshToken) {
                ...
                newRefreshToken = jwtService.generateRefreshToken(contractor._id.toString());
