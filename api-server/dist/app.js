...
app.use((error, req, res, next) => {
    ...
    metricsService.recordError(error.name || "UnknownError", "express-app", "high");
...
logger.info("WebSocket infrastructure initialized with authentication and real-time services");
