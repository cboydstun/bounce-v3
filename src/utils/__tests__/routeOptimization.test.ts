...
const mockedGetDistanceMatrix = getDistanceMatrix as jest.MockedFunction<typeof getDistanceMatrix>;
...
describe('Route Optimization', () => {
    ...
    it('should optimize a route with multiple contacts', async () => {
        ...
        mockedGeocodeAddress.mockResolvedValueOnce([-98.4800, 29.4300]); // Contact 1
        mockedGeocodeAddress.mockResolvedValueOnce([-98.4700, 29.4400]); // Contact 2
        ...
        mockedGetDistanceMatrix.mockResolvedValueOnce({
            ...
            destinations: [
                ...
                { location: [-98.4800, 29.4300] },
                { location: [-98.4700, 29.4400] }
            ],
            sources: [
                { location: [-98.4936, 29.4241] },
                { location: [-98.4800, 29.4300] },
    ...
    it('should handle errors gracefully', async () => {
        ...
        // Execute and assert
        await expect(optimizeRoute(contacts, startAddress)).rejects.toThrow('Route optimization failed');
    });
});
