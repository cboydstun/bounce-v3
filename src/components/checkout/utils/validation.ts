 ...
 */
export const validateStep = (step: OrderStep, state: CheckoutState): Record<string, string> => {
  ...
  switch (step) {
    case "delivery": // Rental Selection
      ...
      if (state.deliveryDate && state.pickupDate) {
        const deliveryDateTime = new Date(`${state.deliveryDate}T${state.deliveryTime || '00:00'}`);
        const pickupDateTime = new Date(`${state.pickupDate}T${state.pickupTime || '00:00'}`);
        
        if (deliveryDateTime >= pickupDateTime) {
          errors.pickupDate = "Pickup date/time must be after delivery date/time";
        }
      }
      break;
    ...
    case "details": // Delivery Information
      ...
      if (state.customerPhone && !validatePhone(state.customerPhone)) {
        errors.customerPhone = "Please enter a valid phone number in format (###)-###-####";
      }
      ...
      if (state.customerZipCode && validateZipCode(state.customerZipCode) && !isBexarCountyZipCode(state.customerZipCode)) {
        errors.customerZipCode = "We only deliver within Bexar County, TX. Please enter a valid Bexar County ZIP code.";
      }
      break;
...
export const isBexarCountyZipCode = (zipCode: string): boolean => {
  ...
  const bexarCountyZipCodes = [
    "78023", "78039", "78052", "78056", "78073", "78101", "78109", "78112", 
    "78124", "78148", "78150", "78152", "78154", "78155", "78163", "78201", 
    "78202", "78203", "78204", "78205", "78206", "78207", "78208", "78209", 
    ...
    "78258", "78259", "78260", "78261", "78263", "78264", "78265", "78266", 
    "78268", "78269", "78270", "78275", "78278", "78279", "78280", "78283", 
    "78284", "78285", "78286", "78287", "78288", "78289", "78291", "78292", 
