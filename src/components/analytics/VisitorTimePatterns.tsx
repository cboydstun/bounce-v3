...
const VisitorTimePatterns: React.FC<VisitorTimePatternsProps> = ({ hourlyData, dailyData }) => {
        ...
        <div className="bg-white p-4 rounded-lg shadow">
            ...
            <div className="mt-4 text-sm text-gray-600">
                ...
                <div className="mt-4 bg-yellow-50 p-3 rounded-lg">
                    <p className="font-medium text-yellow-800">Rental Business Recommendation:</p>
                    <p className="mt-1 text-yellow-700">
                        {activeTab === 'hourly' ? (
                            <>Schedule your customer service availability to align with peak hours ({peakHour.formatted}) to quickly respond to rental inquiries.</>
                        ) : (
                            <>Consider adjusting your inventory preparation and maintenance schedule to ensure maximum availability on {peakDay.formatted}s.</>
                        )}
                    </p>
                </div>
            </div>
