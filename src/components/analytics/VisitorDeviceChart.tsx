...
const VisitorDeviceChart: React.FC<VisitorDeviceChartProps> = ({
  deviceData,
}) => {
  const data = {
      ...
      tooltip: {
        callbacks: {
          label: function (context: any) {
            ...
            const percentage =
              deviceData.percentages[
                label as keyof typeof deviceData.percentages
              ].toFixed(1);
    ...
    <div className="bg-white p-4 rounded-lg shadow">
      ...
      <div className="mt-4 text-sm text-gray-600">
        ...
        {deviceData.percentages.Mobile > 50 ? (
          <p>
            Most of your visitors use mobile devices. Ensure your rental booking
            process is optimized for small screens.
          </p>
        ) : deviceData.percentages.Desktop > 50 ? (
          <p>
            Most of your visitors use desktop computers. Consider showcasing
            detailed product galleries and information.
          </p>
        ) : (
          <p>
            You have a balanced mix of device types. Ensure your site works well
