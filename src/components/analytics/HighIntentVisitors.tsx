...
const HighIntentVisitors: React.FC<HighIntentVisitorsProps> = ({
  visitors,
}) => {
    ...
    <div className="bg-white p-4 rounded-lg shadow">
      ...
      {visitors.length === 0 ? (
        <p className="text-gray-500 text-center py-4">
          No high-intent visitors detected yet.
        </p>
      ) : (
        <div>
          <p className="text-sm text-gray-600 mb-4">
            These visitors have viewed the same page multiple times, indicating
            high interest in your rental products.
          </p>
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        {visitor.visitCount} visits • Last visit:{" "}
                      ...
                      <div className="mt-4 pt-3 border-t border-gray-200">
                        ...
                        {productInterest ? (
                          <p className="text-sm text-gray-600">
                            This visitor has viewed "{productInterest.product}"{" "}
                            {productInterest.count} times. Consider following up
                            with a special offer for this rental product.
                          </p>
                        ) : pageFrequency.length > 0 ? (
                          <p className="text-sm text-gray-600">
                            This visitor has repeatedly viewed "
                            {formatPageUrl(pageFrequency[0].page)}". They may be
                            interested in related rental products.
                          </p>
                        ) : (
                          <p className="text-sm text-gray-600">
                            This visitor has made multiple visits to your site,
                            showing general interest in your rental offerings.
                          </p>
                        )}
                      </div>
                    </div>
      ...
      <div className="mt-6 text-sm text-gray-600">
        ...
        <p className="mt-1">
          High-intent visitors are your most valuable leads. They've shown
          repeated interest in specific rental products and are more likely to
          convert. Consider implementing targeted follow-up strategies for these
          visitors, such as special offers or personalized outreach.
        </p>
      </div>
    </div>
  );
