...
const ConversionFunnelAnalytics: React.FC<ConversionFunnelAnalyticsProps> = ({
  visitors,
}) => {
  ...
  const conversionRates = {
    visitorToProspect:
      totalVisitors > 0 ? (funnelStages.prospect / totalVisitors) * 100 : 0,
    prospectToLead:
      funnelStages.prospect > 0
        ? (funnelStages.lead / funnelStages.prospect) * 100
        : 0,
    leadToOpportunity:
      funnelStages.lead > 0
        ? (funnelStages.opportunity / funnelStages.lead) * 100
        : 0,
    opportunityToCustomer:
      funnelStages.opportunity > 0
        ? (funnelStages.customer / funnelStages.opportunity) * 100
        : 0,
    overallConversion:
      totalVisitors > 0 ? (funnelStages.customer / totalVisitors) * 100 : 0,
  };
  ...
  const visitorsWithConversionEvents = visitors.filter(
    (v) => v.conversionEvents && v.conversionEvents.length > 0,
  );
  ...
  const averageConversionValue =
    conversionValueCount > 0 ? totalConversionValue / conversionValueCount : 0;
  ...
  visitorsWithConversionEvents.forEach((visitor) => {
    if (visitor.conversionEvents) {
      visitor.conversionEvents.forEach((event) => {
        ...
        conversionEventCounts[eventType] =
          (conversionEventCounts[eventType] || 0) + 1;
      });
    }
  });
      ...
      <div className="mb-6">
        <div className="relative pt-1">
          ...
          <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-blue-200">
            <div
              style={{ width: `${getWidthPercentage(funnelStages.visitor)}%` }}
        ...
        <div className="relative pt-1">
          ...
          <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-green-200">
            <div
              style={{ width: `${getWidthPercentage(funnelStages.prospect)}%` }}
        ...
        <div className="relative pt-1">
          ...
          <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-yellow-200">
            <div
              style={{ width: `${getWidthPercentage(funnelStages.lead)}%` }}
        ...
        <div className="relative pt-1">
          ...
          <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-orange-200">
            <div
              style={{
                width: `${getWidthPercentage(funnelStages.opportunity)}%`,
              }}
        ...
        <div className="relative pt-1">
          ...
          <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-red-200">
            <div
              style={{ width: `${getWidthPercentage(funnelStages.customer)}%` }}
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
          <div className="bg-gray-50 p-2 rounded">
            ...
            <p
              className={`text-lg font-bold ${getConversionRateColor(conversionRates.visitorToProspect)}`}
            >
          ...
          <div className="bg-gray-50 p-2 rounded">
            ...
            <p
              className={`text-lg font-bold ${getConversionRateColor(conversionRates.prospectToLead)}`}
            >
          ...
          <div className="bg-gray-50 p-2 rounded">
            ...
            <p
              className={`text-lg font-bold ${getConversionRateColor(conversionRates.leadToOpportunity)}`}
            >
          ...
          <div className="bg-gray-50 p-2 rounded">
            ...
            <p
              className={`text-lg font-bold ${getConversionRateColor(conversionRates.opportunityToCustomer)}`}
            >
          ...
          <div className="bg-blue-50 p-2 rounded">
            ...
            <p
              className={`text-lg font-bold ${getConversionRateColor(conversionRates.overallConversion)}`}
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        <div className="border border-gray-200 rounded-lg p-3">
          ...
          {sortedProducts.length > 0 ? (
            ...
            <p className="text-sm text-gray-500">
              No product conversions recorded yet.
            </p>
          )}
        </div>
      </div>
      ...
      <div className="mt-6 text-sm text-gray-600">
        ...
        <ul className="list-disc list-inside mt-2 space-y-2">
          {conversionRates.visitorToProspect < 5 && (
            <li>
              Your visitor-to-prospect conversion rate is low. Consider adding
              more prominent call-to-action buttons on your product pages.
            </li>
          )}

          {conversionRates.prospectToLead < 10 && funnelStages.prospect > 0 && (
            <li>
              Your prospect-to-lead conversion rate could be improved. Review
              your contact form to ensure it's easy to complete.
            </li>
          )}

          {conversionRates.leadToOpportunity < 15 && funnelStages.lead > 0 && (
            <li>
              Consider following up with leads more quickly to improve your
              lead-to-opportunity conversion rate.
            </li>
          )}

          {conversionRates.opportunityToCustomer < 20 &&
            funnelStages.opportunity > 0 && (
              <li>
                Your opportunity-to-customer conversion rate suggests potential
                issues in the final booking process. Simplify the checkout flow.
              </li>
            )}

          {conversionRates.overallConversion < 2 && totalVisitors > 100 && (
            <li>
              Your overall conversion rate is below industry average. Consider
              A/B testing different elements of your rental booking process.
            </li>
          )}

          {sortedProducts.length > 0 && (
            <li>
              Your top converting product is "
              {sortedProducts[0][0].replace(/-/g, " ")}". Consider featuring
              this product more prominently on your homepage.
            </li>
          )}

          {averageConversionValue > 0 && (
            <li>
              Your average conversion value is $
              {averageConversionValue.toFixed(2)}. Focus marketing efforts on
              products with higher than average values.
            </li>
          )}
        </ul>
      </div>
