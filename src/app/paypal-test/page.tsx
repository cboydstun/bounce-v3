    ...
    <div className="max-w-4xl mx-auto p-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="bg-gray-100 p-4 rounded-md">
              ...
              <p className="text-sm text-gray-500 mt-2">
                This is loaded from your NEXT_PUBLIC_PAYPAL_CLIENT_ID environment variable.
              </p>
            </div>
          </div>
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        ...
        <ul className="list-disc list-inside space-y-2">
          <li>Make sure your <code className="bg-gray-100 px-1 py-0.5 rounded">NEXT_PUBLIC_PAYPAL_CLIENT_ID</code> is correctly set in <code className="bg-gray-100 px-1 py-0.5 rounded">.env.local</code></li>
          ...
          <li>Verify that your PayPal account is properly configured for accepting payments</li>
          <li>If testing in development, make sure you're using a PayPal Sandbox account</li>
        </ul>
      </div>
    </div>
  );
