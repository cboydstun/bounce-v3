...
describe('Visitor API - Single Visitor Endpoints', () => {
    ...
    describe('GET /api/v1/visitors/[id]', () => {
        it('should return a visitor when found', async () => {
            ...
            // Create request
            const req = new NextRequest('http://localhost:3000/api/v1/visitors/visitor-id-123');
        ...
        it('should return 404 when visitor is not found', async () => {
            ...
            // Create request
            const req = new NextRequest('http://localhost:3000/api/v1/visitors/non-existent-id');
