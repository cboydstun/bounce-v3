...
describe('Blogs API', () => {
    ...
    beforeEach(async () => {
        ...
        const admin = await User.create({
            ...
            name: 'Admin User',
            role: 'admin',
        }) as Document & { _id: { toString(): string }; email: string; role: string };
    ...
    describe('GET /api/v1/blogs', () => {
        ...
        it('should filter blogs by category', async () => {
            const req = new NextRequest('http://localhost:3000/api/v1/blogs?category=tech');
        ...
        it('should filter blogs by tag', async () => {
            const req = new NextRequest('http://localhost:3000/api/v1/blogs?tag=health');
        ...
        it('should search blogs by text', async () => {
            const req = new NextRequest('http://localhost:3000/api/v1/blogs?search=blog 1');
