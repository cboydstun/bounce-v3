...
export default function UpdateVisitorLocations() {
  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-8">
        <p className="mb-4">
          This tool will update location data for all visitors based on their IP
          addresses. It uses the IP-API.com service to get location data.
        </p>
        <p className="mb-4">
          The process may take some time depending on the number of visitors
          without location data. Visitors are processed in batches to avoid
          hitting rate limits.
        </p>
        <p className="mb-4 text-yellow-600">
          <strong>Note:</strong> This process will only update visitors without
          location data. Visitors that already have location data will not be
          affected.
        </p>
      </div>
