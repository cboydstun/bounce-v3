...
export default function VisitorsPage() {
    ...
    const [activeTab, setActiveTab] = useState<'overview' | 'visitors' | 'insights'>('overview');
        ...
        <div className="container mx-auto p-4">
            ...
            {loading ? (
                ...
                <div className="text-center p-16 bg-white rounded-lg shadow">
                    <h3 className="text-xl font-semibold mb-2">No visitor data available yet</h3>
                    ...
                    {activeTab === 'insights' && (
                        <div className="space-y-6">
                            ...
                            <div className="bg-white p-4 rounded-lg shadow">
                                <h3 className="text-lg font-semibold mb-4">Rental Business Recommendations</h3>
                                
                                <div className="space-y-4">
                                    <div className="border-l-4 border-blue-500 pl-4 py-2">
                                        <p className="font-medium">Optimize for {deviceData.percentages.Mobile > 50 ? 'Mobile' : 'Desktop'} Users</p>
                                    ...
                                    {highIntentVisitors.length > 0 && (
                                        <div className="border-l-4 border-green-500 pl-4 py-2">
                                            <p className="font-medium">Follow Up with High-Intent Visitors</p>
                                            <p className="text-sm text-gray-600 mt-1">
                                                You have {highIntentVisitors.length} high-intent visitors who have viewed the same products multiple times.
                                                Consider implementing a follow-up strategy for these potential customers.
                                            </p>
                                        </div>
                                    )}
                                    ...
                                    <div className="border-l-4 border-purple-500 pl-4 py-2">
                                        ...
                                        <p className="text-sm text-gray-600 mt-1">
                                            {popularPages.some(page => page.page.includes('/products/'))
                                                ? `Your most viewed product page is "${popularPages.find(page => page.page.includes('/products/'))?.page.split('/').pop()?.replace(/-/g, ' ')}". 
                                ...
                                <table className="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200">
                                        {visitors.map((visitor) => (
                                            <tr key={String(visitor._id)} className="hover:bg-gray-50 cursor-pointer" 
                                                onClick={() => router.push(`/admin/visitors/${visitor._id}`)}>
