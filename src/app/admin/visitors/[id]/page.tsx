                ...
                <div className="bg-white shadow rounded-lg p-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <div>
                            ...
                            <p>{visitor.browser.name} {visitor.browser.version}</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p>{visitor.os.name} {visitor.os.version}</p>
                        </div>
                        <div>
                            <p className="text-sm text-gray-500">Screen Resolution</p>
                            <p>{visitor.screen.width} x {visitor.screen.height} ({visitor.screen.colorDepth}-bit)</p>
                        </div>
                        <div>
                ...
                <div className="bg-white shadow rounded-lg p-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <div>
                            ...
                            <p>{visitor.timezone.name} (UTC{visitor.timezone.offset >= 0 ? '+' : ''}{visitor.timezone.offset})</p>
                        </div>
                            ...
                            <div>
                                ...
                                <ul className="list-disc list-inside text-sm">
                                    ...
                                    {visitor.hardware.gpuVendor && (
                                        <li>GPU: {visitor.hardware.gpuVendor} {visitor.hardware.gpuRenderer}</li>
                                    )}
                                </ul>
                            </div>
                        )}
            ...
            {visitor.userAgent && (
                <div className="bg-white shadow rounded-lg p-6 mt-6">
                    ...
                    <div className="bg-gray-100 p-4 rounded overflow-x-auto">
                        <code className="text-sm font-mono break-all">{visitor.userAgent}</code>
                    </div>
                </div>
            )}
        </div>
