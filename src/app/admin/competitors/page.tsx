        ...
        <div className="lg:col-span-1">
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <div className="text-sm text-gray-500 space-y-4">
              <p>
                Competitors are businesses that compete with you in search
                results. Tracking your competitors helps you understand your
                market position.
              </p>
              <p>
                Add your main competitors here to track them in the search
                rankings dashboard. Active competitors will be highlighted in
