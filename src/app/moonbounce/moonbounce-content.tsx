...
// Moonbounce-specific Hero Section
function MoonbounceHero() {
  return (
    <div className="relative w-full min-h-[800px] flex items-center justify-center bg-cover bg-center bg-fixed overflow-hidden">
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-4 py-20 text-center">
        ...
        <p className="text-2xl md:text-3xl text-white mb-12 max-w-4xl mx-auto leading-relaxed drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)] animate-fade-in-up">
          Professional and timely moonbounce rentals with
...
// Moonbounce Benefits Section
function MoonbounceBenefits() {
  const benefits = [
    {
      title: "Professional Moonbounce Setup",
      description:
        "Our experienced team handles all moonbounce installation and safety checks for worry-free entertainment.",
      icon: "🏗️",
    },
    {
      title: "Free Moonbounce Delivery",
      description:
        "Complimentary moonbounce delivery and pickup throughout San Antonio within Loop 1604.",
      icon: "🚚",
    },
    {
      title: "Safe & Clean Moonbounces",
      description:
        "All moonbounces are thoroughly sanitized and inspected before each rental for maximum safety.",
      icon: "✨",
    },
    {
      title: "No Deposit Required",
      description:
        "Book your moonbounce rental with confidence - no upfront deposit needed for our services.",
      icon: "💳",
    },
  ];
    ...
    <div className="w-full bg-white py-16 mt-4">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-4 text-primary-blue">
          Why Choose Our Moonbounce Rentals?
        </h2>
        <p className="text-xl text-center mb-12 text-gray-600 max-w-3xl mx-auto">
          SATX Bounce is San Antonio's trusted moonbounce rental service,
          providing safe, clean, and professionally managed moonbounce
          experiences for all your special events.
        </p>
...
// Moonbounce Service Areas Section
function MoonbounceServiceAreas() {
  const serviceAreas = [
  ...
  return (
    <div className="w-full bg-secondary-blue/5 py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-4 text-primary-blue">
          Moonbounce Delivery Throughout San Antonio
        </h2>
        <p className="text-xl text-center mb-12 text-white max-w-3xl mx-auto">
          We provide professional moonbounce rental services with free delivery
          to communities throughout the San Antonio metropolitan area within
          Loop 1604.
        </p>
        ...
        <div className="text-center mt-8">
          <p className="text-white">
            ...
            to check if we service your location for moonbounce rentals.
          </p>
        </div>
      </div>
    </div>
...
// Moonbounce FAQ Section
function MoonbounceFAQ() {
  const faqs = [
    {
      question: "What is the difference between a moonbounce and bounce house?",
      answer:
        "Moonbounce and bounce house are different terms for the same inflatable entertainment structure. 'Moonbounce' is a popular regional term, especially common in certain areas, while 'bounce house' is more widely used. Our moonbounce rentals offer the same safe, fun experience regardless of what you call them!",
    },
    {
      question: "How far in advance should I book a moonbounce rental?",
      answer:
        "We recommend booking your moonbounce rental at least 1-2 weeks in advance, especially during peak party seasons (spring and summer). However, we often have moonbounces available for last-minute bookings - just give us a call!",
    },
    {
      question: "What's included with my moonbounce rental?",
      answer:
        "Every moonbounce rental includes free delivery within Loop 1604, professional setup and takedown, safety stakes and sandbags, and a thorough cleaning before your event. We handle everything so you can focus on enjoying your party!",
    },
    {
      question: "Are your moonbounces safe for children?",
      answer:
        "Absolutely! All our moonbounces are regularly inspected, properly maintained, and meet safety standards. We provide safety guidelines and our professional team ensures proper installation with secure anchoring for safe bouncing fun.",
    },
  ];
...
export function MoonbounceContent() {
  return (
    <>
      {/* Moonbounce Hero Section */}
      <MoonbounceHero />
      ...
      {/* Product Carousel - Same products but moonbounce context */}
      <ProductCarousel />

      {/* Moonbounce Service Areas */}
      <MoonbounceServiceAreas />
      ...
      <div id="contact-form" className="container mx-auto px-4 py-16">
        <h2 className="text-3xl font-bold text-center mb-4 text-white">
          Ready to Book Your Moonbounce?
        </h2>
        <p className="text-xl text-center mb-12 text-white/90 max-w-3xl mx-auto">
          Get in touch for your San Antonio moonbounce rental. Free delivery,
      ...
      <div className="flex justify-center items-center py-4 my-4">
        <div className="w-full max-w-[80%] bg-[#f8f5fa] rounded-xl px-8 py-8 text-center">
          <h2 className="text-3xl font-bold mb-6 text-primary-purple">
            Ready to Make Your Event Unforgettable with a Moonbounce?
          </h2>
          <p className="text-xl mb-8 text-primary-blue">
            Book your moonbounce rental now and get free delivery within Loop
            1604!
          </p>
          <PackageDealsCTA
            href="/coupon-form?promo=moonbounce"
